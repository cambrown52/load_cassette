classdef Parked< cassette.simulation.turbinestate.BaseState
    ...
    methods
        ...
        function to_bladed(obj,template)
            ...
            template.replaceProperty("CALCN",15)

            index_runconfig=template.findLine("<RunConfiguration>",method="contains");
            template.replaceXMLProperty("Calculation",15,after_index=index_runconfig)
